...
<!--            <img src="img/client-1295901_960_720.png" style="max-height: 5%;max-width: 5%;margin-left: 48%;opacity:1.0;"> <h1 style="text-align: center;color: black">Medicine Guide</h1>-->
            ...
            <li><a href="chatbot.php" style="color:white;"> AI Chatbot</a></li>
             <li><a href="expert_form.php" style="color:white;">Find Hospital</a></li>
            <li><a href="predict.php" style="color:white;">Disease Prediction</a></li>
					<!--	<li><a href="cussignup.php" style="color:white;">Customer_SignUp</a></li>
						<li><a href="pharsignup.php" style="color:white;">Pharmacy_SignUp</a></li>-->
    ...
    <div class="slider">
<!--  <h2></h2>  -->
  <div id="myCarousel" class="carousel slide" data-ride="carousel" style="width: 1520px;">
    <!-- Indicators -->
