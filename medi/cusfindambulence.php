    ...
    <div class="main-area">
        ...
        <div class="">
            <form class="col-md-4 col-sm-offset-4 text-center" style="margin: 2%;text-align: center;margin-left: 35%;padding-top: 2%;padding-bottom: 2%;" method="post" action=cusfindambulence2.php >
                ...
                <a href="/medi/ambulance_booking.php" style="color: red">Book Ambulance</a>
		...
		<div class="result_table" style="margin-left: 2%;text-align: center width: 1300px;">
            <table style="background:white;border:1px solid black;" class="text-center"; style="width: 600%;">
                <thead>
                    <tr>
...
//                          $str1=$_POST["search"];
                        ...
                        while( $row = mysqli_fetch_assoc( $result ) ){
                            echo "<tr><td>{$row['hospitalName']}</td><td>{$row['hmobile']}</td><td>{$row['amRegion']}</td><td>{$row['hospitalAddress']}</td></tr>\n";
                        }
                    }
                      }
